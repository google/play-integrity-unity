...
namespace Google.Play.Integrity
{
    ...
    /// </summary>
    public class IntegrityServiceError : IDisposable
    {
        /// <summary>
        ...
        private readonly PlayCoreIntegrityServiceException _internalException;
        private bool _disposed;

        internal IntegrityServiceError(AndroidJavaObject javaException)
        {
            ...
            _internalException = new PlayCoreIntegrityServiceException(javaException);
        ...
        internal PlayCoreIntegrityServiceException GetInternalException()
        {
            if (_disposed) throw new ObjectDisposedException(nameof(IntegrityServiceError));
